...
#ifndef QTRSensors_teensy3_h
#define QTRSensors_teensy3_h
...
class QTRSensors
{
  ...
  // taken.
  void read(unsigned short *sensor_values, unsigned char readMode = QTR_EMITTERS_ON);
  ...
  void readCalibrated(unsigned short *sensor_values, unsigned char readMode = QTR_EMITTERS_ON);
  ...
  short readLine(unsigned short *sensor_values, unsigned char readMode = QTR_EMITTERS_ON, unsigned char white_line = 0);
  ...
  unsigned short *calibratedMinimumOn;
  unsigned short *calibratedMaximumOn;
  unsigned short *calibratedMinimumOff;
  unsigned short *calibratedMaximumOff;
  ...
  unsigned short _maxValue; // the maximum value returned by this function
  ...
  void calibrateOnOrOff(unsigned short **calibratedMinimum,
...
class QTRSensorsRC : public QTRSensors
{
  ...
  QTRSensorsRC(unsigned char* pins, unsigned char numSensors, 
      unsigned short timeout = 4000, unsigned char emitterPin = 255);
  ...
  void init(unsigned char* pins, unsigned char numSensors, 
      unsigned short timeout = 2000, unsigned char emitterPin = QTR_NO_EMITTER_PIN);
  ...
  void readPrivate(unsigned short *sensor_values);
};
